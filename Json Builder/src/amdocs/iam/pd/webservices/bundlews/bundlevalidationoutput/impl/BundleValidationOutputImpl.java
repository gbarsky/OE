 ...
 */
public class BundleValidationOutputImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.BundleValidationOutput
{
    
    public BundleValidationOutputImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType getDATA()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType target = null;
            target = (amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType)get_store().find_element_user(DATA$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDATA(amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType data)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType)get_store().add_element_user(DATA$2);
            }
            target.set(data);
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlews.bundlevalidationoutput.DataType addNewDATA()
    {
        synchronized (monitor())
        {
            check_orphaned();
