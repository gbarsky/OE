 ...
 */
public class ComponentsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutput.Components
{
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom getComponentCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom)get_store().find_element_user(COMPONENTCUSTOM$18, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setComponentCustom(amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom componentCustom)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom)get_store().add_element_user(COMPONENTCUSTOM$18);
            }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundlelistoutputimpl.ComponentCustom addNewComponentCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
