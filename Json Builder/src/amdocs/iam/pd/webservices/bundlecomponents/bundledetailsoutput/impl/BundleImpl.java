 ...
 */
public class BundleImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Bundle
{
    ...
    private static final javax.xml.namespace.QName ATTRIBUTES$20 = 
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom getBundleCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom)get_store().find_element_user(BUNDLECUSTOM$16, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setBundleCustom(amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom bundleCustom)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom)get_store().add_element_user(BUNDLECUSTOM$16);
            }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutputimpl.BundleCustom addNewBundleCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components[] getComponentsArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components[] result = new amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components[targetList.size()];
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components getComponentsArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components)get_store().find_element_user(COMPONENTS$18, i);
            if (target == null)
            {
     ...
     */
    public void setComponentsArray(amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components[] componentsArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setComponentsArray(int i, amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components components)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components insertNewComponents(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components)get_store().insert_element_user(COMPONENTS$18, i);
            return target;
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components addNewComponents()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Components)get_store().add_element_user(COMPONENTS$18);
            return target;
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes[] getAttributesArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            java.util.List targetList = new java.util.ArrayList();
            get_store().find_all_element_users(ATTRIBUTES$20, targetList);
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes[] result = new amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes[targetList.size()];
            targetList.toArray(result);
            return result;
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes getAttributesArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes)get_store().find_element_user(ATTRIBUTES$20, i);
            if (target == null)
            {
                throw new IndexOutOfBoundsException();
            }
    ...
    public int sizeOfAttributesArray()
    {
        ...
        {
            check_orphaned();
            return get_store().count_elements(ATTRIBUTES$20);
        }
    }
     ...
     */
    public void setAttributesArray(amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes[] attributesArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
            arraySetterHelper(attributesArray, ATTRIBUTES$20);
        }
    }
     ...
     */
    public void setAttributesArray(int i, amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes attributes)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes insertNewAttributes(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes)get_store().insert_element_user(ATTRIBUTES$20, i);
            return target;
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes addNewAttributes()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes target = null;
            target = (amdocs.iam.pd.webservices.bundlecomponents.bundledetailsoutput.Attributes)get_store().add_element_user(ATTRIBUTES$20);
            return target;
        }
    }
    ...
    public void removeAttributes(int i)
    {
        ...
        {
            check_orphaned();
            get_store().remove_element(ATTRIBUTES$20, i);
        }
    }
}
