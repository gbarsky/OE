 ...
 */
public class DataTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.productoffer.mediatypelistinput.DataType
{
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes getCustomerParameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes target = null;
            target = (amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes)get_store().find_element_user(CUSTOMERPARAMETERS$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCustomerParameters(amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes customerParameters)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes)get_store().add_element_user(CUSTOMERPARAMETERS$2);
            }
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.mediatypelistinput.CustomerParameterTypes addNewCustomerParameters()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom getDataCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom target = null;
            target = (amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom)get_store().find_element_user(DATACUSTOM$4, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDataCustom(amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom dataCustom)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom)get_store().add_element_user(DATACUSTOM$4);
            }
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.mediatypelistinputimpl.DataCustom addNewDataCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
