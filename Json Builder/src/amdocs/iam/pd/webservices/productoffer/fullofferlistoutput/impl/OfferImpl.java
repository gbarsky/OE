 ...
 */
public class OfferImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.productoffer.fullofferlistoutput.Offer
{
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom getOfferCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom target = null;
            target = (amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom)get_store().find_element_user(OFFERCUSTOM$8, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOfferCustom(amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom offerCustom)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom)get_store().add_element_user(OFFERCUSTOM$8);
            }
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.fullofferlistoutputimpl.OfferCustom addNewOfferCustom()
    {
        synchronized (monitor())
        {
            check_orphaned();
