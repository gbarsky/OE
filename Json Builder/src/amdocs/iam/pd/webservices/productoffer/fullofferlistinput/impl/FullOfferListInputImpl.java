 ...
 */
public class FullOfferListInputImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements amdocs.iam.pd.webservices.productoffer.fullofferlistinput.FullOfferListInput
{
    
    public FullOfferListInputImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data getDATA()
    {
        synchronized (monitor())
        {
            check_orphaned();
            amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data target = null;
            target = (amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data)get_store().find_element_user(DATA$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDATA(amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data data)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data)get_store().add_element_user(DATA$2);
            }
            target.set(data);
        }
    }
     ...
     */
    public amdocs.iam.pd.webservices.productoffer.fullofferlistinput.Data addNewDATA()
    {
        synchronized (monitor())
        {
            check_orphaned();
